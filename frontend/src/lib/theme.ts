...
export const TOKENS: Record<ThemeMode, Tokens> = {
  dark: {
    ...
    accent: "#ff7a1f",
    accentLight: "#ffb061",
    accentSoft: "rgba(255,122,31,0.16)",
    accentGrad: "linear-gradient(135deg,#ffb061,#ff5a1f)",
    series: "#5b8def",
    warn: "#ffb061",
    cat0: "#ff7a1f",
    cat1: "#5b8def",
    ...
    shadowCard: "inset 0 1px 0 rgba(255,255,255,0.06), 0 10px 34px rgba(0,0,0,0.30)",
    cardBg: "rgba(255,255,255,0.045)",
    cardBg2: "rgba(255,255,255,0.03)",
    textSecondary: "#a7aeb8",
    hoverbarBg: "rgba(20,21,26,0.92)",
    hoverbarBorder: "rgba(255,255,255,0.12)",
    hoverbarText: "#f6f7f9",
    hoverbarTextHover: "#ffb061",
    hoverbarBtnHover: "rgba(255,122,31,0.16)",
    siderBg: "rgba(255,255,255,0.05)",
    headerBg: "rgba(11,12,16,0.6)",
    auroraA: "rgba(255,122,31,0.20)",
    auroraB: "rgba(91,141,239,0.16)",
    chartAccent: "#ff7a1f",
    chartSeries: "#5b8def",
    chartUp: "#ff5b5b",
    chartDown: "#37c871",
  ...
  light: {
    ...
    accent: "#ff7a1f",
    accentLight: "#ffb061",
    accentSoft: "rgba(255,122,31,0.14)",
    accentGrad: "linear-gradient(135deg,#ffb061,#ff5a1f)",
    series: "#5b8def",
    warn: "#fa8c16",
    cat0: "#ff7a1f",
    ...
    radiusXs: "6px",
    radiusLg: "16px",
    shadow: "0 2px 10px rgba(18,24,45,0.08)",
    shadowSm: "0 1px 3px rgba(18,24,45,0.08)",
    shadowCard: "inset 0 1px 0 rgba(255,255,255,0.85), 0 12px 32px rgba(18,24,45,0.08)",
    ...
    hoverbarText: "#1b1d22",
    hoverbarTextHover: "#ff7a1f",
    hoverbarBtnHover: "rgba(255,122,31,0.12)",
    siderBg: "rgba(255,255,255,0.8)",
    headerBg: "rgba(243,245,249,0.72)",
    auroraA: "rgba(255,122,31,0.16)",
    auroraB: "rgba(91,141,239,0.12)",
    chartAccent: "#ff7a1f",
    chartSeries: "#5b8def",
    chartUp: "#dc2626",
    chartDown: "#16a34a",
...
export function antdTokens(mode: ThemeMode) {
  ...
  return {
    ...
    colorInfo: t.accent,
    colorLink: t.accent,
    colorBgBase: mode === "dark" ? "#0b0c10" : "#f3f5f9",
...
export function themeComponents(mode: ThemeMode) {
  ...
  return {
    ...
    Menu: {
      ...
      itemSelectedBg: dark ? "rgba(255,122,31,0.18)" : "rgba(255,122,31,0.14)",
      itemSelectedColor: dark ? "#ffd0ad" : "#c8520a",
      itemBorderRadius: 8,
      itemMarginInline: 10,
      itemHeight: 42,
      iconSize: 17,
    ...
    Table: { headerBg: dark ? "rgba(255,255,255,0.05)" : "rgba(255,255,255,0.6)", headerColor: t.text2 },
